...
export default function ProductDetails({
  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      ...
      <div className="bg-gray-100 rounded-lg shadow-lg overflow-hidden mt-8 py-5 px-5">
        <img
          className="h-60 w-70 mb-4"
          src={`/images/${product.image.name}`}
          alt={`${product.image.name} image`}
        />
        <div className="p-6">
          <h1 className="uppercase text-3xl font-semibold mb-4">
            {product.name}
          </h1>
          ...
          <div className="flex justify-between items-center mt-6 mb-4">
            <div>
              ...
              <input
                type="number"
                className="mx-3 w-16 text-center"
                value={quantity}
